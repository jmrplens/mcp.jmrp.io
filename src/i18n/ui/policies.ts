...
export const policies = {
  ...
  es: {
    ...
    policiesIntro:
      "Qué datos ven y guardan estos servidores, qué pasa si el servicio se cae, de dónde parece venir una petición, y la base legal de todo ello.",
     ...
     */
    credentialNotice:
      "Solo gitlab pide una. A dónde va ese valor, qué impide el propio navegador y cómo acotarlo y revocarlo está entero en su aviso de seguridad, en la portada:",
