...
export const inspector = {
  en: {
     ...
     */
    inspectorMetaTitle:
      "Inspector — try the MCP servers in your browser · mcp.jmrp.io",
    ...
    insp: {
      ...
      emptyTemplates:
        "No templates loaded yet. A template is a resource address with {placeholders} to fill in.",
      loadServerDoc: "Ask the server (initialize)",
      emptyServerDoc:
        "Nothing read yet. The server sends this once, in its answer to initialize.",
      noInstructions: "This server sends no instructions.",
      notOffered:
        "This server does not offer this. It answered “method not found” (-32601): the category does not exist on it, which is not a failure.",
      docName: "Name",
      docTitle: "Title",
      docVersion: "Version",
  ...
  es: {
    ...
    inspectorMetaTitle:
      "Inspector — prueba servidores MCP en tu navegador · mcp.jmrp.io",
    /** The page's `<h1>`. Prefixed for the same reason as the keys above. */
    inspectorTitle: "Inspector",
    inspectorEyebrow: "Inspector",
    inspectorIntro:
    ...
    insp: {
      ...
      tabServer: "Servidor",
      loadTemplates: "Cargar templates",
      emptyTemplates:
        "Aún no has cargado los templates. Un template es la dirección de un resource con {huecos} que rellenar.",
      loadServerDoc: "Preguntar al servidor (initialize)",
      emptyServerDoc:
        "Aún no se ha leído. El servidor lo envía una vez, en su respuesta a initialize.",
      noInstructions: "Este servidor no envía instrucciones.",
      notOffered:
        "Este servidor no ofrece esto. Ha contestado «method not found» (-32601): la categoría no existe en él, y eso no es un fallo.",
      docName: "Nombre",
      docTitle: "Título",
      docVersion: "Versión",
      docDescription: "Descripción",
      docWebsite: "Web",
      docProtocol: "Protocolo",
      docCapabilities: "Capacidades",
